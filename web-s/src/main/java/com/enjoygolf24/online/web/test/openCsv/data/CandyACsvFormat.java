...
public class CandyACsvFormat {
	...
	private FixedWidthFields getDataRecordFields() {
		...
		dataRecordFields.addField("コード区分", 15).setFieldLength(2, 15);
		dataRecordFields.addField("委託者コード ", 3).setFieldLength(3, 3);
		dataRecordFields.addField("委託者名", 15).setFieldLength(4, 15);
